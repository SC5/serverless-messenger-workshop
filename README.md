# Serverless Messenger Bot Workshop by ![SC5 logo](https://logo.sc5.io/images/sc5logo-red-inverted-100x43.png) 

**The Objective**

To create a Facebook Messenger chatbot using Serverless Framework to build backend for the service.
